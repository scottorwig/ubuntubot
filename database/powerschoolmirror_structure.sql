...
MySQL - 5.1.30-community : Database - powerschoolmirror
*********************************************************************
*/
...
/*Table structure for table `elementary_absences` */

CREATE TABLE `elementary_absences` (
  `Student_Number` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `Grade_Level` varchar(2) COLLATE latin1_general_ci DEFAULT NULL,
  `Absence_Date` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `Absence_ID` varchar(10) COLLATE latin1_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

/*Table structure for table `elementary_tardies` */

CREATE TABLE `elementary_tardies` (
  `Student_Number` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `Grade_Level` varchar(2) COLLATE latin1_general_ci DEFAULT NULL,
  `Tardy_Date` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `Tardy_ID` varchar(10) COLLATE latin1_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
CREATE TABLE `gradestats` (
  ...
  `CumulativeGPA` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `CumulativeCredits` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `Semester1GPA` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `Semester2GPA` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `ClassRank` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
...
/*Table structure for table `log_mi_custom` */

CREATE TABLE `log_mi_custom` (
  `LogID` varchar(20) COLLATE latin1_general_ci NOT NULL,
  `MI_Expl_ExpelLength` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `MI_SpEd_Incident_Duration` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `MI_SpEd_Incident_ActionDate` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `MI_SpEd_Incident_Date` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `MI_SpEd_Discipline_Action_Taken` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `MI_Expl_DamageCost` decimal(10,0) DEFAULT NULL,
  `MI_Expl_IncidentPrimaryVictim` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `MI_Expl_IncidentTime` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `MI_Expl_IncidentLocation` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `MI_Expl_IncidentType` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  `MI_Discipline_Incident_ID` varchar(20) COLLATE latin1_general_ci DEFAULT NULL,
  PRIMARY KEY (`LogID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
/*Table structure for table `meta_updates` */

CREATE TABLE `meta_updates` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `time_start` datetime DEFAULT NULL,
  `time_finish` datetime DEFAULT NULL,
  `students_inserted` int(11) DEFAULT NULL,
  `teachers_inserted` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
/*Table structure for table `afric_female` */

DROP TABLE IF EXISTS `afric_female`;

/*!50001 CREATE TABLE  `afric_female`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
 `ACT_reading` varchar(50) ,
 `ACT_science` varchar(50) ,
 `Alert_Discipline` varchar(500) ,
 `Alert_DisciplineExpires` date ,
 `Alert_Guardian` varchar(500) ,
 `Alert_GuardianExpires` date ,
 `Alert_Medical` varchar(500) ,
 `Alert_MedicalExpires` date ,
 `Alert_Other` varchar(500) ,
 `Alert_OtherExpires` date ,
 `allergies` varchar(50) ,
 `AllowWebAccess` varchar(50) ,
 `Apartment_Number` varchar(50) ,
 `Applic_Response_Recvd_Date` date ,
 `Applic_Submitted_Date` date ,
 `area` varchar(50) ,
 `ATE_skill_cert` varchar(50) ,
 `Autosend_howoften` varchar(50) ,
 `Balance1` varchar(50) ,
 `Balance2` varchar(50) ,
 `Balance3` varchar(50) ,
 `Balance4` varchar(50) ,
 `Building` varchar(50) ,
 `BusNumberDropoff` varchar(50) ,
 `BusNumberPickup` varchar(50) ,
 `Bus_Route` varchar(50) ,
 `Bus_Stop` varchar(50) ,
 `CampusID` varchar(50) ,
 `City` varchar(50) ,
 `ClassOf` varchar(50) ,
 `cnt1_city` varchar(50) ,
 `cnt1_cphone` varchar(50) ,
 `cnt1_custody` varchar(50) ,
 `cnt1_email` varchar(100) ,
 `cnt1_employer` varchar(50) ,
 `cnt1_fname` varchar(50) ,
 `cnt1_hphone` varchar(50) ,
 `cnt1_lname` varchar(50) ,
 `cnt1_recvmail` varchar(50) ,
 `cnt1_rel` varchar(50) ,
 `cnt1_state` varchar(50) ,
 `cnt1_street` varchar(50) ,
 `cnt1_WPhone` varchar(50) ,
 `cnt1_zip` varchar(50) ,
 `cnt2_city` varchar(50) ,
 `cnt2_cphone` varchar(50) ,
 `cnt2_custody` varchar(50) ,
 `cnt2_email` varchar(100) ,
 `cnt2_employer` varchar(50) ,
 `cnt2_fname` varchar(50) ,
 `cnt2_hphone` varchar(50) ,
 `cnt2_lname` varchar(50) ,
 `cnt2_recvmail` varchar(50) ,
 `cnt2_rel` varchar(50) ,
 `cnt2_state` varchar(50) ,
 `cnt2_street` varchar(50) ,
 `Cnt2_WPhone` varchar(50) ,
 `cnt2_zip` varchar(50) ,
 `cnt3_city` varchar(50) ,
 `cnt3_cphone` varchar(50) ,
 `cnt3_custody` varchar(50) ,
 `cnt3_email` varchar(100) ,
 `cnt3_employer` varchar(50) ,
 `cnt3_fname` varchar(50) ,
 `cnt3_hphone` varchar(50) ,
 `cnt3_lname` varchar(50) ,
 `cnt3_recvmail` varchar(50) ,
 `cnt3_rel` varchar(50) ,
 `cnt3_state` varchar(50) ,
 `cnt3_street` varchar(50) ,
 `cnt3_wphone` varchar(50) ,
 `cnt3_zip` varchar(50) ,
 `cnt4_city` varchar(50) ,
 `cnt4_cphone` varchar(50) ,
 `cnt4_custody` varchar(50) ,
 `cnt4_email` varchar(100) ,
 `cnt4_employer` varchar(50) ,
 `cnt4_fname` varchar(50) ,
 `cnt4_hphone` varchar(50) ,
 `cnt4_lname` varchar(50) ,
 `cnt4_recvmail` varchar(50) ,
 `cnt4_rel` varchar(50) ,
 `cnt4_state` varchar(50) ,
 `cnt4_street` varchar(50) ,
 `cnt4_wphone` varchar(50) ,
 `cnt4_zip` varchar(50) ,
 `cnt5_city` varchar(50) ,
 `cnt5_cphone` varchar(50) ,
 `cnt5_custody` varchar(50) ,
 `cnt5_email` varchar(100) ,
 `cnt5_employer` varchar(50) ,
 `cnt5_fname` varchar(50) ,
 `cnt5_hphone` varchar(50) ,
 `cnt5_lname` varchar(50) ,
 `cnt5_recvmail` varchar(50) ,
 `cnt5_rel` varchar(50) ,
 `cnt5_state` varchar(50) ,
 `cnt5_street` varchar(50) ,
 `cnt5_wphone` varchar(50) ,
 `cnt5_zip` varchar(50) ,
 `Cumulative_GPA` varchar(50) ,
 `Cumulative_Pct` varchar(50) ,
 `CustomRank_GPA` varchar(50) ,
 `dateOfEntryIntoUSA` varchar(30) ,
 `DistrictEntryDate` date ,
 `DistrictEntryGradeLevel` varchar(50) ,
 `DistrictOfResidence` varchar(50) ,
 `DOB` date ,
 ...
 `dtp4` varchar(20) ,
 `dtp5` varchar(20) ,
 `ecnt1_city` varchar(50) ,
 `ecnt1_custody` varchar(50) ,
 `ecnt1_email` varchar(50) ,
 `ecnt1_fname` varchar(50) ,
 `ecnt1_hphone` varchar(50) ,
 `ecnt1_lname` varchar(50) ,
 `ecnt1_recvmail` varchar(50) ,
 `ecnt1_state` varchar(50) ,
 `ecnt1_street` varchar(50) ,
 `ecnt1_WPhone` varchar(50) ,
 `ecnt1_zip` varchar(50) ,
 `ecnt2_city` varchar(50) ,
 `ecnt2_cphone` varchar(50) ,
 `ecnt2_custody` varchar(50) ,
 `ecnt2_email` varchar(50) ,
 `ecnt2_fname` varchar(50) ,
 `ecnt2_hphone` varchar(50) ,
 `ecnt2_lname` varchar(50) ,
 `ecnt2_recvmail` varchar(50) ,
 `ecnt2_rel` varchar(50) ,
 `ecnt2_state` varchar(50) ,
 `ecnt2_street` varchar(50) ,
 `ecnt2_WPhone` varchar(50) ,
 `ecnt2_zip` varchar(50) ,
 `ecnt3_city` varchar(50) ,
 `ecnt3_cphone` varchar(50) ,
 `ecnt3_custody` varchar(50) ,
 `ecnt3_email` varchar(50) ,
 `ecnt3_fname` varchar(50) ,
 `ecnt3_hphone` varchar(50) ,
 `ecnt3_lname` varchar(50) ,
 `ecnt3_recvmail` varchar(50) ,
 `ecnt3_rel` varchar(50) ,
 `ecnt3_state` varchar(50) ,
 `ecnt3_street` varchar(50) ,
 `ecnt3_wphone` varchar(50) ,
 `ecnt3_zip` varchar(50) ,
 `ecnt4_city` varchar(50) ,
 `ecnt4_cphone` varchar(50) ,
 `ecnt4_custody` varchar(50) ,
 `ecnt4_email` varchar(50) ,
 `ecnt4_fname` varchar(50) ,
 `ecnt4_hphone` varchar(50) ,
 `ecnt4_lname` varchar(50) ,
 `ecnt4_rel` varchar(50) ,
 `ecnt4_state` varchar(50) ,
 `ecnt4_street` varchar(50) ,
 `ecnt4_wphone` varchar(50) ,
 `ecnt4_zip` varchar(50) ,
 `ecnt5_city` varchar(50) ,
 `ecnt5_cphone` varchar(50) ,
 `ecnt5_custody` varchar(50) ,
 `ecnt5_email` varchar(50) ,
 `ecnt5_fname` varchar(50) ,
 `ecnt5_hphone` varchar(50) ,
 `ecnt5_lname` varchar(50) ,
 `ecnt5_recvmail` varchar(50) ,
 `ecnt5_rel` varchar(50) ,
 `ecnt5_state` varchar(50) ,
 `ecnt5_street` varchar(50) ,
 `ecnt5_wphone` varchar(50) ,
 `ecnt5_zip` varchar(50) ,
 `eecnt1_cphone` varchar(50) ,
 `eecnt1_rel` varchar(50) ,
 `Emerg_1_Ptype` varchar(50) ,
 `Emerg_1_Rel` varchar(50) ,
 `Emerg_2_Ptype` varchar(50) ,
 `Emerg_2_Rel` varchar(50) ,
 `Emerg_3_Phone` varchar(50) ,
 `Emerg_3_Ptype` varchar(50) ,
 `Emerg_3_Rel` varchar(50) ,
 `Emerg_Contact_1` varchar(50) ,
 `Emerg_Contact_2` varchar(50) ,
 `Emerg_Contact_3` varchar(50) ,
 `Emerg_Phone_1` varchar(50) ,
 `Emerg_Phone_2` varchar(50) ,
 `EnrollmentCode` varchar(20) ,
 `EnrollmentType` varchar(20) ,
 `Enrollment_SchoolID` varchar(20) ,
 `Enrollment_Transfer_Date_Pend` varchar(50) ,
 `Enrollment_Transfer_Info` varchar(300) ,
 `Enroll_Status` varchar(20) ,
 `EntryCode` varchar(50) ,
 `EntryDate` date ,
 `ESL_placement` varchar(50) ,
 `Ethnicity` varchar(50) ,
 `Exclude_fr_rank` varchar(50) ,
 `ExitCode` varchar(50) ,
 `ExitComment` varchar(300) ,
 `ExitDate` date ,
 `eye_data` varchar(50) ,
 `Family_Ident` varchar(50) ,
 `Father` varchar(50) ,
 `fatherdayphone` varchar(50) ,
 `Father_Employer` varchar(50) ,
 `Father_home_phone` varchar(50) ,
 `Father_StudentCont_guid` varchar(50) ,
 `FedEthnicity` varchar(50) ,
 `FedRaceDecline` varchar(50) ,
 `Fee_Exemption_Status` varchar(50) ,
 `First_Name` varchar(50) ,
 `FTEID` varchar(50) ,
 `FullTimeEquiv_obsolete` varchar(50) ,
 `Gender` varchar(50) ,
 `Geocode` varchar(100) ,
 `Grade_Level` varchar(50) ,
 `GradReqSet` varchar(50) ,
 `GradReqSetID` varchar(50) ,
 `Graduated_Rank` varchar(50) ,
 `Graduated_SchoolID` varchar(50) ,
 `Graduated_SchoolName` varchar(50) ,
 `graduation_year` varchar(50) ,
 `guardian` varchar(100) ,
 `guardiandayphone` varchar(50) ,
 `GuardianEmail` varchar(100) ,
 `GuardianFax` varchar(50) ,
 `guardianship` varchar(50) ,
 `Guardian_FN` varchar(50) ,
 `Guardian_LN` varchar(50) ,
 `Guardian_MN` varchar(50) ,
 `Guardian_StudentCont_guid` varchar(50) ,
 `hearing_data` varchar(50) ,
 `height_data` varchar(50) ,
 `hepatitis` varchar(50) ,
 `hepatitis1` varchar(50) ,
 `hepatitis2` varchar(50) ,
 `hepatitis3` varchar(50) ,
 `hepatitis4` varchar(50) ,
 `hepatitis_a` varchar(50) ,
 `hepatitis_a1` varchar(50) ,
 `hepatitis_a2` varchar(50) ,
 `hib` varchar(50) ,
 `hib1` varchar(50) ,
 `hib2` varchar(50) ,
 `hib3` varchar(50) ,
 ...
 `homeless_code` varchar(100) ,
 `House` varchar(50) ,
 `ID` varchar(50) ,
 `ID_Immune_Status` varchar(50) ,
 `ILDP` varchar(50) ,
 `include_time_share` varchar(50) ,
 `Inf1` varchar(50) ,
 `Inf2` varchar(50) ,
 `IsSpecialEdEligible` varchar(20) ,
 `LastFirst` varchar(50) ,
 `LastMeal` varchar(50) ,
 `Last_Name` varchar(50) ,
 `LDAPEnabled` varchar(50) ,
 `LEP_exit_date` varchar(30) ,
 `LEP_status` varchar(50) ,
 `Locker_Combination` varchar(50) ,
 `Locker_Number` varchar(50) ,
 `Log` varchar(3000) ,
 `Lot_Number` varchar(50) ,
 `LPAC_date` varchar(50) ,
 `LunchStatus` varchar(50) ,
 `Lunch_ID` varchar(50) ,
 `Mailing_Geocode` varchar(100) ,
 `Mailing_City` varchar(50) ,
 `Mailing_State` varchar(50) ,
 `Mailing_Street` varchar(50) ,
 `Mailing_Zip` varchar(50) ,
 `medical_considerations` varchar(300) ,
 `med_other1` varchar(100) ,
 `med_other2` varchar(100) ,
 `med_other3` varchar(100) ,
 `med_other4` varchar(100) ,
 `med_other5` varchar(100) ,
 `meis_attendance` varchar(50) ,
 `meis_fte_in_gen_ed` varchar(50) ,
 `MembershipShare` varchar(50) ,
 `Middle_Name` varchar(50) ,
 `MI_ECDaysPerWeek` varchar(20) ,
 `MI_ECDaysPerWeek2` varchar(20) ,
 `MI_ECDeliveryMethod` varchar(30) ,
 `MI_ECDeliveryMethod2` varchar(20) ,
 `MI_ECDeliveryMethod3` varchar(20) ,
 `MI_ECDeliveryMethod4` varchar(20) ,
 `MI_ECDeliveryMethod5` varchar(20) ,
 `MI_ECHoursPerDay` varchar(20) ,
 `MI_ECHoursPerDay2` varchar(20) ,
 `MI_ECProgramEndDate` varchar(20) ,
 `MI_ECProgramEndDate2` varchar(20) ,
 `MI_ECProgramStartDate` varchar(20) ,
 `MI_ECProgramStartDate2` varchar(20) ,
 `MI_EI_EligibilityCode` varchar(20) ,
 `MI_EI_ExitCode` varchar(20) ,
 `MI_EI_ExitDate` varchar(20) ,
 `MI_EI_IFSPDate` varchar(20) ,
 `MI_EI_PartBEligible` varchar(20) ,
 `MI_EI_PrimarySetting` varchar(20) ,
 `MI_EI_Service1` varchar(20) ,
 `MI_EI_Service2` varchar(20) ,
 `MI_EI_Service3` varchar(20) ,
 `MI_EI_Service4` varchar(20) ,
 `MI_ethnAfr` varchar(50) ,
 `MI_ethnAsi` varchar(50) ,
 `MI_ethnInd` varchar(50) ,
 `MI_ethnLat` varchar(50) ,
 `MI_ethnPac` varchar(50) ,
 `MI_ethnWhi` varchar(50) ,
 `MI_Father_Cust_No` varchar(20) ,
 `MI_FiscalEntityCode` varchar(20) ,
 `MI_FiscalEntityTypeCode` varchar(20) ,
 `MI_LEP_CountryOrigin` varchar(50) ,
 `MI_LEP_Enrollment` varchar(50) ,
 `MI_LEP_ExitCode` varchar(20) ,
 `MI_LEP_ExitDate` varchar(20) ,
 `MI_LEP_LocFundPgm` varchar(20) ,
 `MI_LEP_PrimaryLanguage` varchar(20) ,
 `MI_LEP_Pupil_LimEng` varchar(20) ,
 `MI_LEP_Refugee_ImpPgm` varchar(20) ,
 `MI_LEP_Title3` varchar(20) ,
 `MI_LEP_Title3_ImmEd` varchar(20) ,
 `MI_LunchStatAppFlag` varchar(20) ,
 `MI_Mother_Cust_No` varchar(20) ,
 `MI_MultipleBirth` varchar(20) ,
 `MI_Resident_County_Code` varchar(20) ,
 `MI_SCMOperISDESANum` varchar(20) ,
 `MI_Setting` varchar(20) ,
 `MI_SpEd_AdditionalDisability` varchar(20) ,
 `MI_SpEd_ExitCode` varchar(20) ,
 `MI_SpEd_ExitDate` varchar(20) ,
 `MI_SpEd_FTE52` varchar(20) ,
 `MI_SpEd_FTE53` varchar(20) ,
 `MI_SpEd_Hours` varchar(20) ,
 `MI_SpEd_IEPAnotherDistrict` varchar(20) ,
 `MI_SpEd_IEPDate` varchar(20) ,
 `MI_SpEd_IEPDays` varchar(20) ,
 `MI_SpEd_ParenConsEval` varchar(20) ,
 `MI_SpEd_PrgmServiceCode1` varchar(20) ,
 `MI_SpEd_PrgmServiceCode2` varchar(20) ,
 `MI_SpEd_PrgmServiceCode3` varchar(20) ,
 `MI_SpEd_PrimaryDisability` varchar(20) ,
 `MI_SpEd_PrimaryEdSetting` varchar(20) ,
 `MI_SpEd_ResofIIEP` varchar(20) ,
 `MI_SpEd_SupportServices1` varchar(20) ,
 `MI_SpEd_SupportServices2` varchar(20) ,
 `MI_SpEd_SupportServices3` varchar(20) ,
 `MI_SpEd_SupportServices4` varchar(20) ,
 `MI_SpEd_SupportServices5` varchar(20) ,
 `MI_SRSD_10_30_DayRule` varchar(20) ,
 `MI_SRSD_AdminUnit` varchar(20) ,
 `MI_SRSD_BirthCity` varchar(20) ,
 `MI_SRSD_Early_Middle_College` varchar(20) ,
 `MI_SRSD_PrgmElig_504` varchar(20) ,
 `MI_SRSD_PrgmElig_EarlyIntervention` varchar(20) ,
 `MI_SRSD_PrgmElig_LEP` varchar(20) ,
 `MI_SRSD_PrgmElig_SpEd` varchar(20) ,
 `MI_SRSD_PrgmElig_Title1` varchar(20) ,
 `MI_SRSD_StudentUIC` varchar(50) ,
 `MI_SRSD_StudResLEANum` varchar(50) ,
 `MI_SRSD_StudResMembership` varchar(50) ,
 `MI_StdntExplus_ExpelDate` varchar(50) ,
 `MI_StdntExplus_ExpelFollowup` varchar(50) ,
 `MI_StdntExplus_ExpelLength` varchar(20) ,
 `MI_StdntExplus_IncidentDate` varchar(20) ,
 `MI_StdntExplus_IncidentLocation` varchar(20) ,
 `MI_StdntExplus_IncidentPrimaryVictim` varchar(20) ,
 `MI_StdntExplus_IncidentTime` varchar(20) ,
 `MI_StuEnrollEC1` varchar(20) ,
 `MI_Unaccompanied_Youth` varchar(20) ,
 `monitor_date` varchar(50) ,
 `Mother` varchar(50) ,
 `motherdayphone` varchar(50) ,
 `Mother_Employer` varchar(50) ,
 `Mother_home_phone` varchar(50) ,
 `Mother_StudentCont_guid` varchar(50) ,
 `Name_Suffix` varchar(50) ,
 `Next_School` varchar(50) ,
 `parttimestudent` varchar(20) ,
 `Person_ID` varchar(50) ,
 `Phone_ID` varchar(50) ,
 `PhotoFlag` varchar(50) ,
 `PL_Language` varchar(50) ,
 `PO_Box` varchar(20) ,
 `polio` varchar(50) ,
 `polio1` varchar(50) ,
 `polio2` varchar(50) ,
 ...
 `rv3` varchar(50) ,
 `SAT` varchar(50) ,
 `Sched_LoadLock` varchar(50) ,
 `Sched_LockStudentSchedule` varchar(50) ,
 `Sched_NextYearBuilding` varchar(50) ,
 `Sched_NextYearBus` varchar(50) ,
 `Sched_NextYearGrade` varchar(50) ,
 `Sched_NextYearHomeRoom` varchar(50) ,
 `Sched_NextYearHouse` varchar(50) ,
 `Sched_NextYearTeam` varchar(50) ,
 `Sched_Priority` varchar(50) ,
 `Sched_Scheduled` varchar(50) ,
 `Sched_YearOfGraduation` varchar(50) ,
 `SchoolEntryDate` varchar(50) ,
 `SchoolEntryGradeLevel` varchar(50) ,
 `SchoolID` varchar(50) ,
 `SDataRN` varchar(50) ,
 `secondarylanguage` varchar(50) ,
 `Simple_GPA` varchar(50) ,
 `Simple_PCT` varchar(50) ,
 `singleparenthshldflag` varchar(50) ,
 `Sports_LHS` varchar(50) ,
 `SSN` varchar(50) ,
 `State` varchar(50) ,
 `State_EnrollFlag` varchar(50) ,
 `State_ExcludeFromReporting` varchar(50) ,
 `State_StudentNumber` varchar(50) ,
 `Street` varchar(50) ,
 `StudentPers_guid` varchar(50) ,
 `StudentPict_guid` varchar(50) ,
 `StudentSchlEnrl_guid` varchar(50) ,
 `Student_AllowWebAccess` varchar(50) ,
 `Student_Number` varchar(50) ,
 `Student_Web_ID` varchar(50) ,
 `Student_Web_Password` varchar(50) ,
 `SummerSchoolID` varchar(50) ,
 `SummerSchoolNote` varchar(50) ,
 `tb1` varchar(50) ,
 `tb2` varchar(50) ,
 `tb3` varchar(50) ,
 `Td` varchar(50) ,
 ...
 `td4` varchar(50) ,
 `td5` varchar(50) ,
 `TeacherGroupID` varchar(50) ,
 `Team` varchar(50) ,
 `Track` varchar(50) ,
 `Tracker` varchar(50) ,
 `TransferComment` varchar(300) ,
 `TuitionPayer` varchar(50) ,
 `Var1` varchar(50) ,
 `Var2` varchar(50) ,
 `varicella` varchar(50) ,
 `Volleyball_7gr_girls` varchar(50) ,
 `Web_ID` varchar(50) ,
 `Web_Password` varchar(50) ,
 `weight_data` varchar(50) ,
 `Withdrawal_Reason_Code` varchar(50) ,
 `WM_Address` varchar(50) ,
 `WM_CreateDate` varchar(50) ,
 `WM_CreateTime` varchar(50) ,
 `WM_Password` varchar(50) ,
 `WM_Status` varchar(50) ,
 `WM_StatusDate` varchar(50) ,
 `WM_TA_Date` varchar(50) ,
 `WM_TA_Flag` varchar(50) ,
 `WM_Tier` varchar(50) ,
 `Zip` varchar(50) 
)*/;

/*Table structure for table `afric_male` */

DROP TABLE IF EXISTS `afric_male`;

/*!50001 CREATE TABLE  `afric_male`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `amind_female` */

DROP TABLE IF EXISTS `amind_female`;

/*!50001 CREATE TABLE  `amind_female`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `amind_male` */

DROP TABLE IF EXISTS `amind_male`;

/*!50001 CREATE TABLE  `amind_male`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `asian_female` */

DROP TABLE IF EXISTS `asian_female`;

/*!50001 CREATE TABLE  `asian_female`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `asian_male` */

DROP TABLE IF EXISTS `asian_male`;

/*!50001 CREATE TABLE  `asian_male`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `hawiian_female` */

DROP TABLE IF EXISTS `hawiian_female`;

/*!50001 CREATE TABLE  `hawiian_female`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `hawiian_male` */

DROP TABLE IF EXISTS `hawiian_male`;

/*!50001 CREATE TABLE  `hawiian_male`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `hisp_female` */

DROP TABLE IF EXISTS `hisp_female`;

/*!50001 CREATE TABLE  `hisp_female`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `hisp_male` */

DROP TABLE IF EXISTS `hisp_male`;

/*!50001 CREATE TABLE  `hisp_male`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `lep_female` */

DROP TABLE IF EXISTS `lep_female`;

/*!50001 CREATE TABLE  `lep_female`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `lep_male` */

DROP TABLE IF EXISTS `lep_male`;

/*!50001 CREATE TABLE  `lep_male`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `multi_female` */

DROP TABLE IF EXISTS `multi_female`;

/*!50001 CREATE TABLE  `multi_female`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `multi_male` */

DROP TABLE IF EXISTS `multi_male`;

/*!50001 CREATE TABLE  `multi_male`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `sec504_female` */

DROP TABLE IF EXISTS `sec504_female`;

/*!50001 CREATE TABLE  `sec504_female`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `sec504_male` */

DROP TABLE IF EXISTS `sec504_male`;

/*!50001 CREATE TABLE  `sec504_male`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `speced_female` */

DROP TABLE IF EXISTS `speced_female`;

/*!50001 CREATE TABLE  `speced_female`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `speced_male` */

DROP TABLE IF EXISTS `speced_male`;

/*!50001 CREATE TABLE  `speced_male`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `white_female` */

DROP TABLE IF EXISTS `white_female`;

/*!50001 CREATE TABLE  `white_female`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*Table structure for table `white_male` */

DROP TABLE IF EXISTS `white_male`;

/*!50001 CREATE TABLE  `white_male`(
 `ACT_composite` varchar(50) ,
 `ACT_date` varchar(20) ,
 `ACT_english` varchar(50) ,
 `ACT_math` varchar(50) ,
...
/*View structure for view afric_female */

/*!50001 DROP TABLE IF EXISTS `afric_female` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `afric_female` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnAfr` = '1') and (`students`.`Gender` = 'F')) */;

/*View structure for view afric_male */

/*!50001 DROP TABLE IF EXISTS `afric_male` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `afric_male` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnAfr` = '1') and (`students`.`Gender` = 'M')) */;

/*View structure for view amind_female */

/*!50001 DROP TABLE IF EXISTS `amind_female` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `amind_female` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnInd` = '1') and (`students`.`Gender` = 'F')) */;

/*View structure for view amind_male */

/*!50001 DROP TABLE IF EXISTS `amind_male` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `amind_male` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnInd` = '1') and (`students`.`Gender` = 'M')) */;

/*View structure for view asian_female */

/*!50001 DROP TABLE IF EXISTS `asian_female` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `asian_female` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnAsi` = '1') and (`students`.`Gender` = 'F')) */;

/*View structure for view asian_male */

/*!50001 DROP TABLE IF EXISTS `asian_male` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `asian_male` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnAsi` = '1') and (`students`.`Gender` = 'M')) */;

/*View structure for view class */

/*!50001 DROP TABLE IF EXISTS `class` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `class` AS select `cc`.`Course_Number` AS `Course_Number`,`cc`.`StudentID` AS `StudentID`,`courses`.`Course_Name` AS `Course_Name` from (`cc` join `courses`) where ((`cc`.`Course_Number` = `courses`.`Course_Number`) and ((`cc`.`TermID` = '1900') or (`cc`.`TermID` = '1901'))) */;

/*View structure for view hawiian_female */

/*!50001 DROP TABLE IF EXISTS `hawiian_female` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `hawiian_female` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnPac` = '1') and (`students`.`Gender` = 'F')) */;

/*View structure for view hawiian_male */

/*!50001 DROP TABLE IF EXISTS `hawiian_male` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `hawiian_male` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnPac` = '1') and (`students`.`Gender` = 'M')) */;

/*View structure for view hisp_female */

/*!50001 DROP TABLE IF EXISTS `hisp_female` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `hisp_female` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnLat` = '1') and (`students`.`Gender` = 'F')) */;

/*View structure for view hisp_male */

/*!50001 DROP TABLE IF EXISTS `hisp_male` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `hisp_male` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnLat` = '1') and (`students`.`Gender` = 'M')) */;

/*View structure for view lep_female */

/*!50001 DROP TABLE IF EXISTS `lep_female` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `lep_female` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_SRSD_PrgmElig_LEP` = 1) and (`students`.`Gender` = 'F')) */;

/*View structure for view lep_male */

/*!50001 DROP TABLE IF EXISTS `lep_male` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `lep_male` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_SRSD_PrgmElig_LEP` = 1) and (`students`.`Gender` = 'M')) */;

/*View structure for view multi_female */

/*!50001 DROP TABLE IF EXISTS `multi_female` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `multi_female` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where (((((((cast(`students`.`MI_ethnLat` as signed) + cast(`students`.`MI_ethnInd` as signed)) + cast(`students`.`MI_ethnAsi` as signed)) + cast(`students`.`MI_ethnPac` as signed)) + cast(`students`.`MI_ethnAfr` as signed)) + cast(`students`.`MI_ethnWhi` as signed)) > 1) and (`students`.`Gender` = 'F')) */;

/*View structure for view multi_male */

/*!50001 DROP TABLE IF EXISTS `multi_male` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `multi_male` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where (((((((cast(`students`.`MI_ethnLat` as signed) + cast(`students`.`MI_ethnInd` as signed)) + cast(`students`.`MI_ethnAsi` as signed)) + cast(`students`.`MI_ethnPac` as signed)) + cast(`students`.`MI_ethnAfr` as signed)) + cast(`students`.`MI_ethnWhi` as signed)) > 1) and (`students`.`Gender` = 'M')) */;

/*View structure for view sec504_female */

/*!50001 DROP TABLE IF EXISTS `sec504_female` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `sec504_female` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_SRSD_PrgmElig_504` = 1) and (`students`.`Gender` = 'F')) */;

/*View structure for view sec504_male */

/*!50001 DROP TABLE IF EXISTS `sec504_male` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `sec504_male` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_SRSD_PrgmElig_504` = 1) and (`students`.`Gender` = 'M')) */;

/*View structure for view speced_female */

/*!50001 DROP TABLE IF EXISTS `speced_female` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `speced_female` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_SRSD_PrgmElig_SpEd` = 1) and (`students`.`Gender` = 'F')) */;

/*View structure for view speced_male */

/*!50001 DROP TABLE IF EXISTS `speced_male` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `speced_male` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_SRSD_PrgmElig_SpEd` = 1) and (`students`.`Gender` = 'M')) */;

/*View structure for view white_female */

/*!50001 DROP TABLE IF EXISTS `white_female` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `white_female` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnWhi` = '1') and (`students`.`Gender` = 'F')) */;

/*View structure for view white_male */

/*!50001 DROP TABLE IF EXISTS `white_male` */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `white_male` AS select `students`.`ACT_composite` AS `ACT_composite`,`students`.`ACT_date` AS `ACT_date`,`students`.`ACT_english` AS `ACT_english`,`students`.`ACT_math` AS `ACT_math`,`students`.`ACT_reading` AS `ACT_reading`,`students`.`ACT_science` AS `ACT_science`,`students`.`Alert_Discipline` AS `Alert_Discipline`,`students`.`Alert_DisciplineExpires` AS `Alert_DisciplineExpires`,`students`.`Alert_Guardian` AS `Alert_Guardian`,`students`.`Alert_GuardianExpires` AS `Alert_GuardianExpires`,`students`.`Alert_Medical` AS `Alert_Medical`,`students`.`Alert_MedicalExpires` AS `Alert_MedicalExpires`,`students`.`Alert_Other` AS `Alert_Other`,`students`.`Alert_OtherExpires` AS `Alert_OtherExpires`,`students`.`allergies` AS `allergies`,`students`.`AllowWebAccess` AS `AllowWebAccess`,`students`.`Apartment_Number` AS `Apartment_Number`,`students`.`Applic_Response_Recvd_Date` AS `Applic_Response_Recvd_Date`,`students`.`Applic_Submitted_Date` AS `Applic_Submitted_Date`,`students`.`area` AS `area`,`students`.`ATE_skill_cert` AS `ATE_skill_cert`,`students`.`Autosend_howoften` AS `Autosend_howoften`,`students`.`Balance1` AS `Balance1`,`students`.`Balance2` AS `Balance2`,`students`.`Balance3` AS `Balance3`,`students`.`Balance4` AS `Balance4`,`students`.`Building` AS `Building`,`students`.`BusNumberDropoff` AS `BusNumberDropoff`,`students`.`BusNumberPickup` AS `BusNumberPickup`,`students`.`Bus_Route` AS `Bus_Route`,`students`.`Bus_Stop` AS `Bus_Stop`,`students`.`CampusID` AS `CampusID`,`students`.`City` AS `City`,`students`.`ClassOf` AS `ClassOf`,`students`.`cnt1_city` AS `cnt1_city`,`students`.`cnt1_cphone` AS `cnt1_cphone`,`students`.`cnt1_custody` AS `cnt1_custody`,`students`.`cnt1_email` AS `cnt1_email`,`students`.`cnt1_employer` AS `cnt1_employer`,`students`.`cnt1_fname` AS `cnt1_fname`,`students`.`cnt1_hphone` AS `cnt1_hphone`,`students`.`cnt1_lname` AS `cnt1_lname`,`students`.`cnt1_recvmail` AS `cnt1_recvmail`,`students`.`cnt1_rel` AS `cnt1_rel`,`students`.`cnt1_state` AS `cnt1_state`,`students`.`cnt1_street` AS `cnt1_street`,`students`.`cnt1_WPhone` AS `cnt1_WPhone`,`students`.`cnt1_zip` AS `cnt1_zip`,`students`.`cnt2_city` AS `cnt2_city`,`students`.`cnt2_cphone` AS `cnt2_cphone`,`students`.`cnt2_custody` AS `cnt2_custody`,`students`.`cnt2_email` AS `cnt2_email`,`students`.`cnt2_employer` AS `cnt2_employer`,`students`.`cnt2_fname` AS `cnt2_fname`,`students`.`cnt2_hphone` AS `cnt2_hphone`,`students`.`cnt2_lname` AS `cnt2_lname`,`students`.`cnt2_recvmail` AS `cnt2_recvmail`,`students`.`cnt2_rel` AS `cnt2_rel`,`students`.`cnt2_state` AS `cnt2_state`,`students`.`cnt2_street` AS `cnt2_street`,`students`.`Cnt2_WPhone` AS `Cnt2_WPhone`,`students`.`cnt2_zip` AS `cnt2_zip`,`students`.`cnt3_city` AS `cnt3_city`,`students`.`cnt3_cphone` AS `cnt3_cphone`,`students`.`cnt3_custody` AS `cnt3_custody`,`students`.`cnt3_email` AS `cnt3_email`,`students`.`cnt3_employer` AS `cnt3_employer`,`students`.`cnt3_fname` AS `cnt3_fname`,`students`.`cnt3_hphone` AS `cnt3_hphone`,`students`.`cnt3_lname` AS `cnt3_lname`,`students`.`cnt3_recvmail` AS `cnt3_recvmail`,`students`.`cnt3_rel` AS `cnt3_rel`,`students`.`cnt3_state` AS `cnt3_state`,`students`.`cnt3_street` AS `cnt3_street`,`students`.`cnt3_wphone` AS `cnt3_wphone`,`students`.`cnt3_zip` AS `cnt3_zip`,`students`.`cnt4_city` AS `cnt4_city`,`students`.`cnt4_cphone` AS `cnt4_cphone`,`students`.`cnt4_custody` AS `cnt4_custody`,`students`.`cnt4_email` AS `cnt4_email`,`students`.`cnt4_employer` AS `cnt4_employer`,`students`.`cnt4_fname` AS `cnt4_fname`,`students`.`cnt4_hphone` AS `cnt4_hphone`,`students`.`cnt4_lname` AS `cnt4_lname`,`students`.`cnt4_recvmail` AS `cnt4_recvmail`,`students`.`cnt4_rel` AS `cnt4_rel`,`students`.`cnt4_state` AS `cnt4_state`,`students`.`cnt4_street` AS `cnt4_street`,`students`.`cnt4_wphone` AS `cnt4_wphone`,`students`.`cnt4_zip` AS `cnt4_zip`,`students`.`cnt5_city` AS `cnt5_city`,`students`.`cnt5_cphone` AS `cnt5_cphone`,`students`.`cnt5_custody` AS `cnt5_custody`,`students`.`cnt5_email` AS `cnt5_email`,`students`.`cnt5_employer` AS `cnt5_employer`,`students`.`cnt5_fname` AS `cnt5_fname`,`students`.`cnt5_hphone` AS `cnt5_hphone`,`students`.`cnt5_lname` AS `cnt5_lname`,`students`.`cnt5_recvmail` AS `cnt5_recvmail`,`students`.`cnt5_rel` AS `cnt5_rel`,`students`.`cnt5_state` AS `cnt5_state`,`students`.`cnt5_street` AS `cnt5_street`,`students`.`cnt5_wphone` AS `cnt5_wphone`,`students`.`cnt5_zip` AS `cnt5_zip`,`students`.`Cumulative_GPA` AS `Cumulative_GPA`,`students`.`Cumulative_Pct` AS `Cumulative_Pct`,`students`.`CustomRank_GPA` AS `CustomRank_GPA`,`students`.`dateOfEntryIntoUSA` AS `dateOfEntryIntoUSA`,`students`.`DistrictEntryDate` AS `DistrictEntryDate`,`students`.`DistrictEntryGradeLevel` AS `DistrictEntryGradeLevel`,`students`.`DistrictOfResidence` AS `DistrictOfResidence`,`students`.`DOB` AS `DOB`,`students`.`Doctor_Name` AS `Doctor_Name`,`students`.`Doctor_Phone` AS `Doctor_Phone`,`students`.`dpt` AS `dpt`,`students`.`dtp1` AS `dtp1`,`students`.`dtp2` AS `dtp2`,`students`.`dtp3` AS `dtp3`,`students`.`dtp4` AS `dtp4`,`students`.`dtp5` AS `dtp5`,`students`.`ecnt1_city` AS `ecnt1_city`,`students`.`ecnt1_custody` AS `ecnt1_custody`,`students`.`ecnt1_email` AS `ecnt1_email`,`students`.`ecnt1_fname` AS `ecnt1_fname`,`students`.`ecnt1_hphone` AS `ecnt1_hphone`,`students`.`ecnt1_lname` AS `ecnt1_lname`,`students`.`ecnt1_recvmail` AS `ecnt1_recvmail`,`students`.`ecnt1_state` AS `ecnt1_state`,`students`.`ecnt1_street` AS `ecnt1_street`,`students`.`ecnt1_WPhone` AS `ecnt1_WPhone`,`students`.`ecnt1_zip` AS `ecnt1_zip`,`students`.`ecnt2_city` AS `ecnt2_city`,`students`.`ecnt2_cphone` AS `ecnt2_cphone`,`students`.`ecnt2_custody` AS `ecnt2_custody`,`students`.`ecnt2_email` AS `ecnt2_email`,`students`.`ecnt2_fname` AS `ecnt2_fname`,`students`.`ecnt2_hphone` AS `ecnt2_hphone`,`students`.`ecnt2_lname` AS `ecnt2_lname`,`students`.`ecnt2_recvmail` AS `ecnt2_recvmail`,`students`.`ecnt2_rel` AS `ecnt2_rel`,`students`.`ecnt2_state` AS `ecnt2_state`,`students`.`ecnt2_street` AS `ecnt2_street`,`students`.`ecnt2_WPhone` AS `ecnt2_WPhone`,`students`.`ecnt2_zip` AS `ecnt2_zip`,`students`.`ecnt3_city` AS `ecnt3_city`,`students`.`ecnt3_cphone` AS `ecnt3_cphone`,`students`.`ecnt3_custody` AS `ecnt3_custody`,`students`.`ecnt3_email` AS `ecnt3_email`,`students`.`ecnt3_fname` AS `ecnt3_fname`,`students`.`ecnt3_hphone` AS `ecnt3_hphone`,`students`.`ecnt3_lname` AS `ecnt3_lname`,`students`.`ecnt3_recvmail` AS `ecnt3_recvmail`,`students`.`ecnt3_rel` AS `ecnt3_rel`,`students`.`ecnt3_state` AS `ecnt3_state`,`students`.`ecnt3_street` AS `ecnt3_street`,`students`.`ecnt3_wphone` AS `ecnt3_wphone`,`students`.`ecnt3_zip` AS `ecnt3_zip`,`students`.`ecnt4_city` AS `ecnt4_city`,`students`.`ecnt4_cphone` AS `ecnt4_cphone`,`students`.`ecnt4_custody` AS `ecnt4_custody`,`students`.`ecnt4_email` AS `ecnt4_email`,`students`.`ecnt4_fname` AS `ecnt4_fname`,`students`.`ecnt4_hphone` AS `ecnt4_hphone`,`students`.`ecnt4_lname` AS `ecnt4_lname`,`students`.`ecnt4_rel` AS `ecnt4_rel`,`students`.`ecnt4_state` AS `ecnt4_state`,`students`.`ecnt4_street` AS `ecnt4_street`,`students`.`ecnt4_wphone` AS `ecnt4_wphone`,`students`.`ecnt4_zip` AS `ecnt4_zip`,`students`.`ecnt5_city` AS `ecnt5_city`,`students`.`ecnt5_cphone` AS `ecnt5_cphone`,`students`.`ecnt5_custody` AS `ecnt5_custody`,`students`.`ecnt5_email` AS `ecnt5_email`,`students`.`ecnt5_fname` AS `ecnt5_fname`,`students`.`ecnt5_hphone` AS `ecnt5_hphone`,`students`.`ecnt5_lname` AS `ecnt5_lname`,`students`.`ecnt5_recvmail` AS `ecnt5_recvmail`,`students`.`ecnt5_rel` AS `ecnt5_rel`,`students`.`ecnt5_state` AS `ecnt5_state`,`students`.`ecnt5_street` AS `ecnt5_street`,`students`.`ecnt5_wphone` AS `ecnt5_wphone`,`students`.`ecnt5_zip` AS `ecnt5_zip`,`students`.`eecnt1_cphone` AS `eecnt1_cphone`,`students`.`eecnt1_rel` AS `eecnt1_rel`,`students`.`Emerg_1_Ptype` AS `Emerg_1_Ptype`,`students`.`Emerg_1_Rel` AS `Emerg_1_Rel`,`students`.`Emerg_2_Ptype` AS `Emerg_2_Ptype`,`students`.`Emerg_2_Rel` AS `Emerg_2_Rel`,`students`.`Emerg_3_Phone` AS `Emerg_3_Phone`,`students`.`Emerg_3_Ptype` AS `Emerg_3_Ptype`,`students`.`Emerg_3_Rel` AS `Emerg_3_Rel`,`students`.`Emerg_Contact_1` AS `Emerg_Contact_1`,`students`.`Emerg_Contact_2` AS `Emerg_Contact_2`,`students`.`Emerg_Contact_3` AS `Emerg_Contact_3`,`students`.`Emerg_Phone_1` AS `Emerg_Phone_1`,`students`.`Emerg_Phone_2` AS `Emerg_Phone_2`,`students`.`EnrollmentCode` AS `EnrollmentCode`,`students`.`EnrollmentType` AS `EnrollmentType`,`students`.`Enrollment_SchoolID` AS `Enrollment_SchoolID`,`students`.`Enrollment_Transfer_Date_Pend` AS `Enrollment_Transfer_Date_Pend`,`students`.`Enrollment_Transfer_Info` AS `Enrollment_Transfer_Info`,`students`.`Enroll_Status` AS `Enroll_Status`,`students`.`EntryCode` AS `EntryCode`,`students`.`EntryDate` AS `EntryDate`,`students`.`ESL_placement` AS `ESL_placement`,`students`.`Ethnicity` AS `Ethnicity`,`students`.`Exclude_fr_rank` AS `Exclude_fr_rank`,`students`.`ExitCode` AS `ExitCode`,`students`.`ExitComment` AS `ExitComment`,`students`.`ExitDate` AS `ExitDate`,`students`.`eye_data` AS `eye_data`,`students`.`Family_Ident` AS `Family_Ident`,`students`.`Father` AS `Father`,`students`.`fatherdayphone` AS `fatherdayphone`,`students`.`Father_Employer` AS `Father_Employer`,`students`.`Father_home_phone` AS `Father_home_phone`,`students`.`Father_StudentCont_guid` AS `Father_StudentCont_guid`,`students`.`FedEthnicity` AS `FedEthnicity`,`students`.`FedRaceDecline` AS `FedRaceDecline`,`students`.`Fee_Exemption_Status` AS `Fee_Exemption_Status`,`students`.`First_Name` AS `First_Name`,`students`.`FTEID` AS `FTEID`,`students`.`FullTimeEquiv_obsolete` AS `FullTimeEquiv_obsolete`,`students`.`Gender` AS `Gender`,`students`.`Geocode` AS `Geocode`,`students`.`Grade_Level` AS `Grade_Level`,`students`.`GradReqSet` AS `GradReqSet`,`students`.`GradReqSetID` AS `GradReqSetID`,`students`.`Graduated_Rank` AS `Graduated_Rank`,`students`.`Graduated_SchoolID` AS `Graduated_SchoolID`,`students`.`Graduated_SchoolName` AS `Graduated_SchoolName`,`students`.`graduation_year` AS `graduation_year`,`students`.`guardian` AS `guardian`,`students`.`guardiandayphone` AS `guardiandayphone`,`students`.`GuardianEmail` AS `GuardianEmail`,`students`.`GuardianFax` AS `GuardianFax`,`students`.`guardianship` AS `guardianship`,`students`.`Guardian_FN` AS `Guardian_FN`,`students`.`Guardian_LN` AS `Guardian_LN`,`students`.`Guardian_MN` AS `Guardian_MN`,`students`.`Guardian_StudentCont_guid` AS `Guardian_StudentCont_guid`,`students`.`hearing_data` AS `hearing_data`,`students`.`height_data` AS `height_data`,`students`.`hepatitis` AS `hepatitis`,`students`.`hepatitis1` AS `hepatitis1`,`students`.`hepatitis2` AS `hepatitis2`,`students`.`hepatitis3` AS `hepatitis3`,`students`.`hepatitis4` AS `hepatitis4`,`students`.`hepatitis_a` AS `hepatitis_a`,`students`.`hepatitis_a1` AS `hepatitis_a1`,`students`.`hepatitis_a2` AS `hepatitis_a2`,`students`.`hib` AS `hib`,`students`.`hib1` AS `hib1`,`students`.`hib2` AS `hib2`,`students`.`hib3` AS `hib3`,`students`.`hib4` AS `hib4`,`students`.`HLN` AS `HLN`,`students`.`Home_Phone` AS `Home_Phone`,`students`.`Home_Room` AS `Home_Room`,`students`.`homeless` AS `homeless`,`students`.`homeless_code` AS `homeless_code`,`students`.`House` AS `House`,`students`.`ID` AS `ID`,`students`.`ID_Immune_Status` AS `ID_Immune_Status`,`students`.`ILDP` AS `ILDP`,`students`.`include_time_share` AS `include_time_share`,`students`.`Inf1` AS `Inf1`,`students`.`Inf2` AS `Inf2`,`students`.`IsSpecialEdEligible` AS `IsSpecialEdEligible`,`students`.`LastFirst` AS `LastFirst`,`students`.`LastMeal` AS `LastMeal`,`students`.`Last_Name` AS `Last_Name`,`students`.`LDAPEnabled` AS `LDAPEnabled`,`students`.`LEP_exit_date` AS `LEP_exit_date`,`students`.`LEP_status` AS `LEP_status`,`students`.`Locker_Combination` AS `Locker_Combination`,`students`.`Locker_Number` AS `Locker_Number`,`students`.`Log` AS `Log`,`students`.`Lot_Number` AS `Lot_Number`,`students`.`LPAC_date` AS `LPAC_date`,`students`.`LunchStatus` AS `LunchStatus`,`students`.`Lunch_ID` AS `Lunch_ID`,`students`.`Mailing_Geocode` AS `Mailing_Geocode`,`students`.`Mailing_City` AS `Mailing_City`,`students`.`Mailing_State` AS `Mailing_State`,`students`.`Mailing_Street` AS `Mailing_Street`,`students`.`Mailing_Zip` AS `Mailing_Zip`,`students`.`medical_considerations` AS `medical_considerations`,`students`.`med_other1` AS `med_other1`,`students`.`med_other2` AS `med_other2`,`students`.`med_other3` AS `med_other3`,`students`.`med_other4` AS `med_other4`,`students`.`med_other5` AS `med_other5`,`students`.`meis_attendance` AS `meis_attendance`,`students`.`meis_fte_in_gen_ed` AS `meis_fte_in_gen_ed`,`students`.`MembershipShare` AS `MembershipShare`,`students`.`Middle_Name` AS `Middle_Name`,`students`.`MI_ECDaysPerWeek` AS `MI_ECDaysPerWeek`,`students`.`MI_ECDaysPerWeek2` AS `MI_ECDaysPerWeek2`,`students`.`MI_ECDeliveryMethod` AS `MI_ECDeliveryMethod`,`students`.`MI_ECDeliveryMethod2` AS `MI_ECDeliveryMethod2`,`students`.`MI_ECDeliveryMethod3` AS `MI_ECDeliveryMethod3`,`students`.`MI_ECDeliveryMethod4` AS `MI_ECDeliveryMethod4`,`students`.`MI_ECDeliveryMethod5` AS `MI_ECDeliveryMethod5`,`students`.`MI_ECHoursPerDay` AS `MI_ECHoursPerDay`,`students`.`MI_ECHoursPerDay2` AS `MI_ECHoursPerDay2`,`students`.`MI_ECProgramEndDate` AS `MI_ECProgramEndDate`,`students`.`MI_ECProgramEndDate2` AS `MI_ECProgramEndDate2`,`students`.`MI_ECProgramStartDate` AS `MI_ECProgramStartDate`,`students`.`MI_ECProgramStartDate2` AS `MI_ECProgramStartDate2`,`students`.`MI_EI_EligibilityCode` AS `MI_EI_EligibilityCode`,`students`.`MI_EI_ExitCode` AS `MI_EI_ExitCode`,`students`.`MI_EI_ExitDate` AS `MI_EI_ExitDate`,`students`.`MI_EI_IFSPDate` AS `MI_EI_IFSPDate`,`students`.`MI_EI_PartBEligible` AS `MI_EI_PartBEligible`,`students`.`MI_EI_PrimarySetting` AS `MI_EI_PrimarySetting`,`students`.`MI_EI_Service1` AS `MI_EI_Service1`,`students`.`MI_EI_Service2` AS `MI_EI_Service2`,`students`.`MI_EI_Service3` AS `MI_EI_Service3`,`students`.`MI_EI_Service4` AS `MI_EI_Service4`,`students`.`MI_ethnAfr` AS `MI_ethnAfr`,`students`.`MI_ethnAsi` AS `MI_ethnAsi`,`students`.`MI_ethnInd` AS `MI_ethnInd`,`students`.`MI_ethnLat` AS `MI_ethnLat`,`students`.`MI_ethnPac` AS `MI_ethnPac`,`students`.`MI_ethnWhi` AS `MI_ethnWhi`,`students`.`MI_Father_Cust_No` AS `MI_Father_Cust_No`,`students`.`MI_FiscalEntityCode` AS `MI_FiscalEntityCode`,`students`.`MI_FiscalEntityTypeCode` AS `MI_FiscalEntityTypeCode`,`students`.`MI_LEP_CountryOrigin` AS `MI_LEP_CountryOrigin`,`students`.`MI_LEP_Enrollment` AS `MI_LEP_Enrollment`,`students`.`MI_LEP_ExitCode` AS `MI_LEP_ExitCode`,`students`.`MI_LEP_ExitDate` AS `MI_LEP_ExitDate`,`students`.`MI_LEP_LocFundPgm` AS `MI_LEP_LocFundPgm`,`students`.`MI_LEP_PrimaryLanguage` AS `MI_LEP_PrimaryLanguage`,`students`.`MI_LEP_Pupil_LimEng` AS `MI_LEP_Pupil_LimEng`,`students`.`MI_LEP_Refugee_ImpPgm` AS `MI_LEP_Refugee_ImpPgm`,`students`.`MI_LEP_Title3` AS `MI_LEP_Title3`,`students`.`MI_LEP_Title3_ImmEd` AS `MI_LEP_Title3_ImmEd`,`students`.`MI_LunchStatAppFlag` AS `MI_LunchStatAppFlag`,`students`.`MI_Mother_Cust_No` AS `MI_Mother_Cust_No`,`students`.`MI_MultipleBirth` AS `MI_MultipleBirth`,`students`.`MI_Resident_County_Code` AS `MI_Resident_County_Code`,`students`.`MI_SCMOperISDESANum` AS `MI_SCMOperISDESANum`,`students`.`MI_Setting` AS `MI_Setting`,`students`.`MI_SpEd_AdditionalDisability` AS `MI_SpEd_AdditionalDisability`,`students`.`MI_SpEd_ExitCode` AS `MI_SpEd_ExitCode`,`students`.`MI_SpEd_ExitDate` AS `MI_SpEd_ExitDate`,`students`.`MI_SpEd_FTE52` AS `MI_SpEd_FTE52`,`students`.`MI_SpEd_FTE53` AS `MI_SpEd_FTE53`,`students`.`MI_SpEd_Hours` AS `MI_SpEd_Hours`,`students`.`MI_SpEd_IEPAnotherDistrict` AS `MI_SpEd_IEPAnotherDistrict`,`students`.`MI_SpEd_IEPDate` AS `MI_SpEd_IEPDate`,`students`.`MI_SpEd_IEPDays` AS `MI_SpEd_IEPDays`,`students`.`MI_SpEd_ParenConsEval` AS `MI_SpEd_ParenConsEval`,`students`.`MI_SpEd_PrgmServiceCode1` AS `MI_SpEd_PrgmServiceCode1`,`students`.`MI_SpEd_PrgmServiceCode2` AS `MI_SpEd_PrgmServiceCode2`,`students`.`MI_SpEd_PrgmServiceCode3` AS `MI_SpEd_PrgmServiceCode3`,`students`.`MI_SpEd_PrimaryDisability` AS `MI_SpEd_PrimaryDisability`,`students`.`MI_SpEd_PrimaryEdSetting` AS `MI_SpEd_PrimaryEdSetting`,`students`.`MI_SpEd_ResofIIEP` AS `MI_SpEd_ResofIIEP`,`students`.`MI_SpEd_SupportServices1` AS `MI_SpEd_SupportServices1`,`students`.`MI_SpEd_SupportServices2` AS `MI_SpEd_SupportServices2`,`students`.`MI_SpEd_SupportServices3` AS `MI_SpEd_SupportServices3`,`students`.`MI_SpEd_SupportServices4` AS `MI_SpEd_SupportServices4`,`students`.`MI_SpEd_SupportServices5` AS `MI_SpEd_SupportServices5`,`students`.`MI_SRSD_10_30_DayRule` AS `MI_SRSD_10_30_DayRule`,`students`.`MI_SRSD_AdminUnit` AS `MI_SRSD_AdminUnit`,`students`.`MI_SRSD_BirthCity` AS `MI_SRSD_BirthCity`,`students`.`MI_SRSD_Early_Middle_College` AS `MI_SRSD_Early_Middle_College`,`students`.`MI_SRSD_PrgmElig_504` AS `MI_SRSD_PrgmElig_504`,`students`.`MI_SRSD_PrgmElig_EarlyIntervention` AS `MI_SRSD_PrgmElig_EarlyIntervention`,`students`.`MI_SRSD_PrgmElig_LEP` AS `MI_SRSD_PrgmElig_LEP`,`students`.`MI_SRSD_PrgmElig_SpEd` AS `MI_SRSD_PrgmElig_SpEd`,`students`.`MI_SRSD_PrgmElig_Title1` AS `MI_SRSD_PrgmElig_Title1`,`students`.`MI_SRSD_StudentUIC` AS `MI_SRSD_StudentUIC`,`students`.`MI_SRSD_StudResLEANum` AS `MI_SRSD_StudResLEANum`,`students`.`MI_SRSD_StudResMembership` AS `MI_SRSD_StudResMembership`,`students`.`MI_StdntExplus_ExpelDate` AS `MI_StdntExplus_ExpelDate`,`students`.`MI_StdntExplus_ExpelFollowup` AS `MI_StdntExplus_ExpelFollowup`,`students`.`MI_StdntExplus_ExpelLength` AS `MI_StdntExplus_ExpelLength`,`students`.`MI_StdntExplus_IncidentDate` AS `MI_StdntExplus_IncidentDate`,`students`.`MI_StdntExplus_IncidentLocation` AS `MI_StdntExplus_IncidentLocation`,`students`.`MI_StdntExplus_IncidentPrimaryVictim` AS `MI_StdntExplus_IncidentPrimaryVictim`,`students`.`MI_StdntExplus_IncidentTime` AS `MI_StdntExplus_IncidentTime`,`students`.`MI_StuEnrollEC1` AS `MI_StuEnrollEC1`,`students`.`MI_Unaccompanied_Youth` AS `MI_Unaccompanied_Youth`,`students`.`monitor_date` AS `monitor_date`,`students`.`Mother` AS `Mother`,`students`.`motherdayphone` AS `motherdayphone`,`students`.`Mother_Employer` AS `Mother_Employer`,`students`.`Mother_home_phone` AS `Mother_home_phone`,`students`.`Mother_StudentCont_guid` AS `Mother_StudentCont_guid`,`students`.`Name_Suffix` AS `Name_Suffix`,`students`.`Next_School` AS `Next_School`,`students`.`parttimestudent` AS `parttimestudent`,`students`.`Person_ID` AS `Person_ID`,`students`.`Phone_ID` AS `Phone_ID`,`students`.`PhotoFlag` AS `PhotoFlag`,`students`.`PL_Language` AS `PL_Language`,`students`.`PO_Box` AS `PO_Box`,`students`.`polio` AS `polio`,`students`.`polio1` AS `polio1`,`students`.`polio2` AS `polio2`,`students`.`polio3` AS `polio3`,`students`.`polio4` AS `polio4`,`students`.`polio5` AS `polio5`,`students`.`PPV1` AS `PPV1`,`students`.`PPV2` AS `PPV2`,`students`.`prevstudentid` AS `prevstudentid`,`students`.`PVC1` AS `PVC1`,`students`.`PVC2` AS `PVC2`,`students`.`PVC3` AS `PVC3`,`students`.`PVC4` AS `PVC4`,`students`.`rv` AS `rv`,`students`.`rv1` AS `rv1`,`students`.`rv2` AS `rv2`,`students`.`rv3` AS `rv3`,`students`.`SAT` AS `SAT`,`students`.`Sched_LoadLock` AS `Sched_LoadLock`,`students`.`Sched_LockStudentSchedule` AS `Sched_LockStudentSchedule`,`students`.`Sched_NextYearBuilding` AS `Sched_NextYearBuilding`,`students`.`Sched_NextYearBus` AS `Sched_NextYearBus`,`students`.`Sched_NextYearGrade` AS `Sched_NextYearGrade`,`students`.`Sched_NextYearHomeRoom` AS `Sched_NextYearHomeRoom`,`students`.`Sched_NextYearHouse` AS `Sched_NextYearHouse`,`students`.`Sched_NextYearTeam` AS `Sched_NextYearTeam`,`students`.`Sched_Priority` AS `Sched_Priority`,`students`.`Sched_Scheduled` AS `Sched_Scheduled`,`students`.`Sched_YearOfGraduation` AS `Sched_YearOfGraduation`,`students`.`SchoolEntryDate` AS `SchoolEntryDate`,`students`.`SchoolEntryGradeLevel` AS `SchoolEntryGradeLevel`,`students`.`SchoolID` AS `SchoolID`,`students`.`SDataRN` AS `SDataRN`,`students`.`secondarylanguage` AS `secondarylanguage`,`students`.`Simple_GPA` AS `Simple_GPA`,`students`.`Simple_PCT` AS `Simple_PCT`,`students`.`singleparenthshldflag` AS `singleparenthshldflag`,`students`.`Sports_LHS` AS `Sports_LHS`,`students`.`SSN` AS `SSN`,`students`.`State` AS `State`,`students`.`State_EnrollFlag` AS `State_EnrollFlag`,`students`.`State_ExcludeFromReporting` AS `State_ExcludeFromReporting`,`students`.`State_StudentNumber` AS `State_StudentNumber`,`students`.`Street` AS `Street`,`students`.`StudentPers_guid` AS `StudentPers_guid`,`students`.`StudentPict_guid` AS `StudentPict_guid`,`students`.`StudentSchlEnrl_guid` AS `StudentSchlEnrl_guid`,`students`.`Student_AllowWebAccess` AS `Student_AllowWebAccess`,`students`.`Student_Number` AS `Student_Number`,`students`.`Student_Web_ID` AS `Student_Web_ID`,`students`.`Student_Web_Password` AS `Student_Web_Password`,`students`.`SummerSchoolID` AS `SummerSchoolID`,`students`.`SummerSchoolNote` AS `SummerSchoolNote`,`students`.`tb1` AS `tb1`,`students`.`tb2` AS `tb2`,`students`.`tb3` AS `tb3`,`students`.`Td` AS `Td`,`students`.`Td1` AS `Td1`,`students`.`td2` AS `td2`,`students`.`td3` AS `td3`,`students`.`td4` AS `td4`,`students`.`td5` AS `td5`,`students`.`TeacherGroupID` AS `TeacherGroupID`,`students`.`Team` AS `Team`,`students`.`Track` AS `Track`,`students`.`Tracker` AS `Tracker`,`students`.`TransferComment` AS `TransferComment`,`students`.`TuitionPayer` AS `TuitionPayer`,`students`.`Var1` AS `Var1`,`students`.`Var2` AS `Var2`,`students`.`varicella` AS `varicella`,`students`.`Volleyball_7gr_girls` AS `Volleyball_7gr_girls`,`students`.`Web_ID` AS `Web_ID`,`students`.`Web_Password` AS `Web_Password`,`students`.`weight_data` AS `weight_data`,`students`.`Withdrawal_Reason_Code` AS `Withdrawal_Reason_Code`,`students`.`WM_Address` AS `WM_Address`,`students`.`WM_CreateDate` AS `WM_CreateDate`,`students`.`WM_CreateTime` AS `WM_CreateTime`,`students`.`WM_Password` AS `WM_Password`,`students`.`WM_Status` AS `WM_Status`,`students`.`WM_StatusDate` AS `WM_StatusDate`,`students`.`WM_TA_Date` AS `WM_TA_Date`,`students`.`WM_TA_Flag` AS `WM_TA_Flag`,`students`.`WM_Tier` AS `WM_Tier`,`students`.`Zip` AS `Zip` from `students` where ((`students`.`MI_ethnWhi` = '1') and (`students`.`Gender` = 'M')) */;
