...
def clean_with_whitelist(dirty_string):
    clean_string = ''
    string_removed_line_breaks = dirty_string.replace('\n', '')
    string_removed_carriage_returns = string_removed_line_breaks.replace('\r', '')
    string_removed_line_feeds = string_removed_carriage_returns.replace('\n','')
    string_removed_form_feeds = string_removed_line_feeds.replace('\f', '')
    ...
    string_iso_date = date_finder.sub(english_date_to_iso_date,line_characters_from_whitelist)
