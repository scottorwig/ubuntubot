...
print 'Sleeping for 10 seconds before closing file'
time.sleep(10)
file_writer.close()
print 'Sleeping for 10 seconds after closing file'
time.sleep(10)

log_string = '{0} records written to the file at {1}'.format(write_count, fullPathToHostFile)
print log_string
